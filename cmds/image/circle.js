...
module.exports = class CircleCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'circle', // meow
			aliases: [], // kitty-cat
			group: 'image', // fun
			memberName: 'circle', // filename (meow)
			description: 'Circle Image Manipulation', // desc /Replies with a meow, kitty cat.
      guildOnly: true,
//      hidden: true, // false
//      ownerOnly: true,
...
//	run(message, { text }) {    //with args
    ...
    let IMG = await canvacord.Canvas.circle(AV, true)
    let ATTCH = new MessageAttachment(IMG, `circle.png`)
