...
module.exports = class HitlerCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'hitler', // meow
			aliases: [], // kitty-cat
			group: 'image', // fun
			memberName: 'hitler', // filename (meow)
			description: 'Hitler Image Manipulation', // desc /Replies with a meow, kitty cat.
      guildOnly: true,
//      hidden: true, // false
//      ownerOnly: true,
...
//	run(message, { text }) {    //with args
    ...
    let IMG = await canvacord.Canvas.hitler(AV)
    let ATTCH = new MessageAttachment(IMG, `hitler.png`)
